...
#BERTに入れるための入力に変換
def convert_full_sequence_sdp_to_features(examples, max_sdp_length, tokenizer ):
...
def convert_to_features(examples, max_seq_length, tokenizer):
    ...
    for (ex_index, x) in enumerate(examples):
        ...
        input_ids = tokenizer.convert_tokens_to_ids(tokens_a)#idに変換
        #print(input_ids)
        ...
        # pad sdp length here
        max_sdp_length  = 12
        position_mask =  [ int(e) for e in sdp_postion] #  "CLS " があるので+1する
...
with open(path, mode='r') as f:
     for lines in f.readlines():
         ...
         sen = col[4]
         #print(sen)
         feature = convert_to_features(sen, 512, tokenizer)
         print(feature)
"""
